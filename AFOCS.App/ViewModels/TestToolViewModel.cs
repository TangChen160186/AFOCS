...
public class TestToolViewModel(
    ...
    [ImportMany] IEnumerable<IAkribisMotion> akribisMotions) : Tool, ITestTool
{
    ...
    protected override Task OnInitializedAsync(CancellationToken cancellationToken)
    {
        ...
        Task.FromResult(LoadTeachingPointsAsync());
    ...
    /// <summary>移动单个轴，返回 null 表示成功，否则返回错误信息</summary>
